...
class BS():
    ...
    def __init__(self, S, K, T, sigma, r, position, q=0, option_type='Call'):
        self.S = S
        self.K = K
        self.T = T
        self.vol = sigma 
    ...
    def Hedging(self, frequence):
        ...
        Depenses[0] = sign * Price[0] - Buy[0] * S[0]
        Holdings[0] = Delta[0] * S[0]
        Portfolio[0] = Depenses[0] + Holdings[0]
        ...
        for s in range(1, steps + 1):
            ...
            Depenses[s] -= Buy[s] * S[s]
            Holdings[s] = Delta[s] * S[s]
            Portfolio[s] = Depenses[s] + Holdings[s]
